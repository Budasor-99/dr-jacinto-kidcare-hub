          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center">
                <span className="font-heading font-bold text-lg">JS</span>
              </div>
              <div>
                <p className="font-heading font-bold text-lg">Dr. Jacinto Salazar</p>
                <p className="text-primary-foreground/70 text-sm">Médico Pediatra</p>
              </div>
            </div>
        ...
        <div className="border-t border-primary-foreground/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <p className="text-primary-foreground/60 text-sm flex items-center gap-1">
              Hecho con <Heart className="w-4 h-4 text-accent fill-accent" /> para el bienestar infantil
            </p>
          </div>
        </div>
      </div>
