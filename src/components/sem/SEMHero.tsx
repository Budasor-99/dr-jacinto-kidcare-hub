      ...
      <div className="relative z-10 container mx-auto px-4 pb-20 pt-6 md:pt-10">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="relative flex-shrink-0 animate-fade-in">
            ...
            {/* Patients count - Floating */}
            <div className="absolute top-1/2 -right-4 md:-right-8 transform translate-x-full -translate-y-1/2 bg-white/95 backdrop-blur-sm shadow-lg rounded-xl px-3 py-2 border border-primary/5 hidden lg:flex items-center gap-2">
